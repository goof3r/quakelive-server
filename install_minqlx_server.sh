...
UNITEOF
  ...
  # 11d. Definicje trzech trybów.
  # ft  -> factory mg_ft_fullclassic (jest w pliku factory, poprawne)
  # tdm -> mg_tdm_fullclassic (w cfg było 'mg_tdm_classic', którego BRAK w pliku
  #        factory — podmienione na istniejące "Full Classic TDM")
  # ffa -> wbudowane 'ffa' (w cfg było 'mg_ffa_classic', którego BRAK — wbudowane
  #        factory gwarantuje start; własne mg_ffa_aw zostaje dostępne do głosowania)
  write_gt_cfg "tdm" "TDM" "TDM, minqlx, qlstats.net, ELO, TSK, [TSK]," \
    "mappool_tdm.txt" "map campgrounds mg_tdm_fullclassic" "TEAM DEATHMATCH" "TDM"
  write_gt_cfg "ffa" "FFA" "FFA, minqlx, qlstats.net, ELO, tsk, [TSK]," \
    "mappool_ffa.txt" "map longestyard ffa" "FREE FOR ALL" "FFA"
  write_gt_cfg "ft"  "FT"  "FT, FREEZE TAG, minqlx, qlstats.net, ELO, tsk, [TSK]," \
